...
function ensureThemeAssets(){
 if(!document.getElementById('archiveThemeStyles')){const link=document.createElement('link');link.id='archiveThemeStyles';link.rel='stylesheet';link.href='./archive-theme.css?v=36';document.head.appendChild(link)}
